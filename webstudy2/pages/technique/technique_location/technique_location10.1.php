	...
	<form id="myForm" action="index.php?app=technique&action=addlocation10" method="post" enctype="multipart/form-data" accept-charset="utf-8">
		<div class="col-md-12">
			<div class="col-md-12" style=" padding-left: 20px; padding-top: 20px;">
				<div style="font-size: 25px; color: #ff8100;"> 2.9 สังคมและชุมชน (Society and Community) </div>
			</div>
			...
			<div class="row">
				<div class="col-md-10" style=" padding-left: 60px; padding-top:20px">
					<p style="color: #ff8100; font-size:25px">รูปภาพของชุมชน</p>
				</div>
			...
			<div class="row">
				<div class="col-md-10" style=" padding-left: 60px; padding-top: 20px;">
					<p style="font-size:25px; color: #ff8100;">รูปองค์การปกครองส่วนท้องถิ่น</p>
				</div>
				<!-- <<img src="../images/423164.jpg" alt=""> -->
				<div class="file-upload">
			...
			<div class="col-md-12">
				<div class="col-md-12" style="padding-top: 20px;">
					<p style=" font-size: 25px;">2.9.1 โรงเรียนใกล้เคียง</p>
				</div>
				...
				<p style=" font-size: 20px;padding-left: 60px;">สภาพโดยทั่วไปเนื่องจากการดําเนินกิจการโรงงานจะต้องกระทบกับโรงเรียนในเรื่องของมลพิษที่เกิดจากโรงงาน
					...
					<div class="row">
						<div class="col-md-10" style=" padding-left: 60px; padding-top:20px">
							<p style="font-size:25px; color: #ff8100;">รูปภาพโรงเรียน</p>
						</div>
						<!-- <<img src="../images/423164.jpg" alt=""> -->
						<div class="file-upload">
					...
					<div class="col-md-12" style="padding-top:20px;">
						<p style="font-size: 25px;">2.9.2 เทศบาลโรงพยาบาลหรือสถานพยาบาลใกล้เคียง</p>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-10" style=" padding-left: 60px; padding-top: 20px;">
						<p style="color: #ff8100; font-size:25px;">รูปโรงพยาบาล</p>
					</div>
					<!-- <<img src="../images/423164.jpg" alt=""> -->
					<div class="file-upload">
