...
<div class="container">
	<form id="myForm" action="index.php?app=technique&action=addanalysis4" method="post" accept-charset="utf-8">
		<div class="row">
			<div class="col-md-10" style=" padding-left: 60px; padding-top: 20px;">
				<p style="color: #32b4c1 ;">1.6 จํานวนพนักงานและโครงสร้างองค์กรโรงงาน</p>
			</div>
			<div class="col-md-12">
				<table style="width:100%" align="center" id="mytable">
					<tr>
						...
						<th style="text-align: center;">แผนก/ฝ่าย</th>
						<th style="text-align: center;">จำนวน</th>
						<th style="text-align: center;">ประสบการณ์</th>
						<th style="text-align: center;">ปี</th>
						<th style="text-align: center;">ความต้องการเป็นพิเศษ</th>
					</tr>
					<tr>
						<td height="50px"><input type="text" name="no[]" value="" placeholder=""></td>
						<td><input type="text" name="position[]" value="" placeholder=""></td>
						<td><input type="text" name="gender[]" value="" placeholder=""></td>
						<td><input type="text" name="lifespan[]" value="" placeholder=""></td>
						<td><input type="text" name="department[]" value="" placeholder=""></td>
						<td><input type="text" name="number[]" value="" placeholder=""></td>
						<td><input type="text" name="experience[]" value="" placeholder=""></td>
						<td><input type="text" name="year[]" value="" placeholder=""></td>
						<td><input type="text" name="extra[]" value="" placeholder=""></td>
					</tr>
					<tr>
						<td height="50px"><input type="text" name="no[]" value="" placeholder=""></td>
						<td><input type="text" name="position[]" value="" placeholder=""></td>
			...
			<div class="col-md-10" style=" padding-left: 60px; padding-top:20px;">
				<p style="color: #32b4c1 ;">รูปภาพผังงานของบริษัท</p>
			</div>
		...
		<div class="col-sm-12" style="padding-left: 0px; text-align: center;">
			<a href="index.php?app=technique&action=analysis3">กลับ</a>
...
<script>
	...
	function add_fields(id) {
		...
		str += '<td><input type="text" name="gender[]" value="" placeholder=""></td>';
		str += '<td><input type="text" name="lifespan[]" value="" placeholder=""></td>';
		str += '<td><input type="text" name="department[]" value="" placeholder=""></td>';
		str += '<td><input type="text" name="number[]" value="" placeholder=""></td>';
		str += '<td><input type="text" name="experience[]" value="" placeholder=""></td>';
		str += '<td><input type="text" name="year[]" value="" placeholder=""></td>';
		str += '<td><input type="text" name="extra[]" value="" placeholder=""></td>';
		str += '</tr>';
