<div class="container">
	<form id="myForm" action="index.php?app=technique&action=addcost3" method="post" enctype="multipart/form-data" accept-charset="utf-8">
		<div class="row">
			...
			<div class="col-md-12">
				<div class="col-md-10" style=" padding-left: 60px; padding-top: 20px;">
					<div style="font-size: 20px; color: #32B4C1;">3.5 ค่าใช้จ่ายการบํารุงรักษาและอุปกรณ์ (Coolant) เช่น น้ำมันหล่อลื้น ของเหลวที่ใช้ในเครื่องจักร เป็นต้น</div>
				</div>
				<table style="width:100%" align="center" id="mytable">

					<tr style="background-color: #32B4C1;">
						<th style="text-align: center;">ลำดับที่</th>
						<th style="text-align: center;">ชื่อของน้ำมัน</th>
						<th style="text-align: center;">หน่วย<br>(แกลลอน/ถัง200L/อื่นๆ)</th>
					...
					<tr>
						...
						<td><input type="text" name="oil[]" value="" placeholder=""></td>
			...
			<div class="col-md-12">
				<div class="col-md-10" style=" padding-left: 60px;">
					<br>
					<br>
					<div style="font-size: 20px; color: #32B4C1;">3.6 ค่าใช้จ่ายการขนถ่ายในโรงงาน (Material Handling) เช่น สายพานลําเลียง แฮนลิฟท์ รถโฟล์คลิฟ รถ AGV เป็นต้น
					</div>
				</div>
				<table style="width:100%" align="center" id="mytable2">
					...
					<tr style="background-color: #32B4C1;">
						<th style="text-align: center;">ลำดับที่</th>
						<th style="text-align: center;">ชื่ออุปกรณ์ขนถ่ายในโรงงาน</th>
			...
			<div class="col-sm-12" style="padding-left: 0px; text-align: center;">
				<a href="index.php?app=technique&action=cost2">กลับ</a>
...
<script>
	...
	function add_fields(id) {
		...
		str += '<td><input type="text" name="oil[]" value="" placeholder=""></td>';
